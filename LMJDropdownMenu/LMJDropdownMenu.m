...
- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight name:(NSString *)name{
...
- (void)showDropDown{   // 显示下拉列表
    ...
    [UIView animateWithDuration:AnimateTime animations:^{
        ...
        self->_listView.frame  = CGRectMake(VIEW_X(self->_listView), VIEW_Y(self->_listView), VIEW_WIDTH(self->_listView), _rowHeight *_titleArr.count);
